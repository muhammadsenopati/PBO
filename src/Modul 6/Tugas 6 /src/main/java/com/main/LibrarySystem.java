...
public class LibrarySystem extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Selamat Datang di Perpustakaan UMM");

        //Label
        Label sceneTitle    = new Label("Selamat Datang di Perpustakaan UMM");
       ...
       Label errorLoginMessage   = new Label("Pengguna tidak ditemukan");
        ...
        Button logoutButton = new Button("GA JADI DEH");
