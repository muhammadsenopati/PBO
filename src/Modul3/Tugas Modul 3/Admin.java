...
public class Admin extends User {
    ...
    boolean isAdmin() {
        ...
        if (username.equals(adminusername) && password.equals(adminpassword)) {
            ...
            System.out.println("==== Pengguna Tidak Ada ====");
            return false;
        }
    }
